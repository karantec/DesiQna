...
function LowerFeature() {
  return (
   <>
   <div className='mb-10   flex flex-col items-center pt-10 px-[5rem]  bg-gradient-to-r to-red-50 from-yellow-100'>
   ...
   <div className='flex flex-row flex-wrap items-center justify-center gap-[6rem] bg-gradient-to-r to-red-50 from-yellow-100'>
    ...
    <div className='w-[30rem] border-2  rounded-2xl bg-gradient-to-r to-red-50 from-yellow-100 p-[5rem] shadow-[0px_22px_300px_10px_#f56565,19px_3px_72px_13px_#e2e8f0] '>
        <h1 className='text-center text-3xl font-bold mb-[2rem] text-red-500 bg-gradient-to-r to-red-50 from-yellow-100 '>Duration of the Program</h1>
        <p className='text-center font-semibold bg-gradient-to-r to-red-50 from-yellow-100'>Timings : Monday to Sunday [Live DSA Training] 
        </p>
        <p className='text-center font-semibold mt-2 mb-2 bg-gradient-to-r to-red-50 from-yellow-100'>
