...
function Info({ h1, p1, h2, p2, p3, p4, h3, h4,h5,p5,h6,p6,h7,p7,h8,p8,h9,p9,h10,p10,h11,p11,h12,p12,h13,p13,h14,p14 }) {
  return (
    <>
      <div className="flex flex-col items-center justify-center bg-gradient-to-r to-red-50 from-yellow-100 overflow-x-hidden mt-[-1rem]">
        <div>
          <div className="flex flex-col items-center justify-center gap-20">
            <div className="absolute   outline-1   outline-dashed h-[57rem]  lg:h-[240rem] md:h-[50rem] "></div>
