export const data ={
    ...
    subh1:` & 1-1 Mentoring`,
    subh2:`Program`,
    ul1:`Daily Live DSA Class (Online Test + Interview + Competitive Programming) + Doubt Session from Mon-Sun`,
    ...
    ul5:`1-1 Personalized Mentoring By Kumar K Sir(SDE @ Amazon) `,
