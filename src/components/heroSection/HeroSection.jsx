      ...
      <section className="mt-[-1rem]">
        <section className="text-gray-600 body-font bg-gradient-to-r to-red-50 from-yellow-100">
          <div className="container mx-auto px-5 py-24 md:flex md:flex-row md:justify-center">
            ...
            <span className="text-xl text-black font-sans font-bold edu-revo">{data.span1} {" "} <span className="text-red-700">{data.span2}</span></span>
              ...
              <ol className="mt-3 ">
                <li className="mb-4 md:items-start leading-normal text-md text-gray-900 font-sans font-bold">{data.ul1}</li>
                <li className="mb-4  md:items-start leading-normal  text-md  text-gray-900 font-sans font-bold"><span className="text-red-500">558 </span>Students from Tier-3 colleges have Cracked <span className="text-red-500">10+ LPA</span> offers in the last <span className="text-red-500">10 months.</span></li>
                <li className="mb-4 md:items-start leading-normal text-md text-gray-900 font-sans font-bold">Separate Live training batch for Beginners vs Intermediates</li>
                <li className="mb-6  md:items-start  leading-normal  text-md text-gray-900 font-sans font-bold">{data.ul3}</li>
                <li className="mb-6  md:items-start  leading-normal  text-md text-gray-900 font-sans font-bold">{data.ul4}</li>
              </ol>
