      ...
      <section className="mt-[-1rem]">
        <section className="text-gray-600 body-font bg-gradient-to-r to-red-50 from-yellow-100">
          <div className="container mx-auto px-5 py-24 md:flex md:flex-row md:justify-center">
            <div className="md:w-1/2 lg:pr-24 md:pr-15 mb-16 md:mb-0  ml-6">
            <span className="text-xl text-black font-sans font-bold">{data.span1} {" "} <span className="text-red-700">{data.span2}</span></span>
              ...
              <ol className="mt-3">
                <li className="mb-4 md:items-start leading-normal text-md text-gray-900 font-sans">{data.ul1}</li>
                <li className="mb-4  md:items-start leading-normal  text-md  text-gray-900 font-sans">{data.ul2}</li>
                <li className="mb-6  md:items-start  leading-normal  text-md text-gray-900 font-sans">{data.ul3}</li>
                <li className="mb-6  md:items-start  leading-normal  text-md text-gray-900 font-sans">{data.ul4}</li>
              </ol>
