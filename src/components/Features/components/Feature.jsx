        ...
        <section className="text-gray-600 body-font">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center md:space-x-10">
            <div className="md:w-1/2 flex flex-col items-center md:items-start">
              <span className="text-4xl text-blue-600 font-bold mb-4">
                {p}
              </span>
              <h1 className="title-font mt-2 md:mt-0 sm:text-4xl text-3xl mb-4 font-medium text-gray-900 text-center md:text-left">
                {h1}
              </h1>
