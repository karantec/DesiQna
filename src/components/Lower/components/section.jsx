    ...
    />
          ...
          <div className="flex flex-col items-center md:items-start">
            ...
            <p className="text-center md:text-left text-2xl font-sans text-gray-800 font-semibold">
              Founder , DesiQNA <br />
             <span className="text-gray-100"> SDE @ Amazon (Ex)</ span>
            </p>
            <p className="mt-8 mb-8">
              <ol>
                <li className="text-gray-300 font-bold">International  Rank  368  in Google KickStart.</li>
                <li className="text-gray-300 font-bold">All Indian Rank 12 in Google CodeJam.</li>
                <li className="text-gray-300 font-bold">World Rank 15 out of 200000 in Hackerearth From from Tier-4 college  knows the struggle. 
 </li>
                <li className="text-gray-300 font-bold">All India Rank 26 in LeetCode Contest.</li>
                <li className="text-gray-300 font-bold">1 - 1 Personalized Mentored 600 Students in 3  years and 558 students cracked OFF Campus SDE  
                Offer from TopTech Companies.</li>
              </ol>
